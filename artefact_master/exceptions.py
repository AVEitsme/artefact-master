...
class NotRegisteredError(Exception):
    ...
    def __init__(self, artefact_name: str, registered_artefacts: Dict[str, Artefact]) -> None:
...
class AlreadyRegisteredError(Exception):
    ...
    def __init__(self, artefact_name: str) -> None:
        self.artefact_name = artefact_name
        self.message = f"Artefact {artefact_name} already exists in registered artefacts." 
